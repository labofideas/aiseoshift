...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of independent pharmacy AI SEO: GBP local trust signals, pharmacy services content, pharmacist expertise E-E-A-T, and Pharmacy schema">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Chains have scale. Independents have expertise. AI search rewards whichever is better documented.</text>
</svg>
</figure>
