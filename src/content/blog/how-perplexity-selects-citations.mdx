...
description: "A research breakdown of how Perplexity AI chooses which sources to cite in answers. What signals matter, which content types get cited most, and what SEOs can do about it."
...
<svg viewBox="0 0 800 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Perplexity citation selection: five factors that determine which pages get cited">
  ...
  <text x="400" y="324" text-anchor="middle" font-family="Iowan Old Style, Georgia, serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Perplexity retrieves from Bing and then selects for extraction quality, specificity, and source clarity.</text>
</svg>
