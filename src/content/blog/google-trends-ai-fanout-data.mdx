...
description: "SEOs are spotting impossible spikes in Google Trends -- protein powder, SEO, running shoes, and CBD all 'surging' at once. The likely culprit: query fan-out, the background searches Google's AI runs for every AI answer. Here is what is happening and how to read search data now."
