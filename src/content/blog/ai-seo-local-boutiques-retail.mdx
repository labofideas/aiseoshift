...
<svg viewBox="0 0 820 420" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Boutique vs. big-box comparison showing AI citation advantages across five dimensions: geographic specificity, product knowledge, review quality, in-stock signals, and neighborhood content">
  ...
  <text x="410" y="396" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="12" fill="rgb(14,17,22)" fill-opacity="0.65">Four of five AI citation signals favor boutiques when executed correctly.</text>
</svg>
</figure>
