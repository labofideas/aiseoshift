...
<svg viewBox="0 0 820 520" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Venn diagram showing three intersecting circles for Relevance, Distance, and Prominence, with the overlap zone labeled Local Pack and AI Citations">
  ...
  <text x="410" y="514" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Businesses that score strongly across all three factors rank in the Local Pack and earn AI citations for local queries.</text>
</svg>
</figure>
