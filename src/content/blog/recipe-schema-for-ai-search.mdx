...
<figure class="post-figure">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 760 480" width="760" height="480" role="img" aria-label="Recipe schema completeness spectrum comparing minimal schema with only basic properties to complete schema with all properties including nutrition, video, and author">
    ...
    <rect x="40" y="56" width="310" height="340" fill="rgb(250,250,247)" rx="6" stroke="rgb(220,215,205)" stroke-width="1"/>
    ...
    <text x="195" y="102" font-family="Georgia, serif" font-size="10" fill="rgb(120,115,108)" text-anchor="middle">Citation probability: LOW</text>
    ...
    <rect x="60" y="200" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="213" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">recipeInstructions (plain text)</text>
    <rect x="60" y="228" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="241" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">image — missing</text>
    <rect x="60" y="256" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="269" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">nutrition — missing</text>
    <rect x="60" y="284" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="297" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">author — missing</text>
    <rect x="60" y="312" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="325" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">video — missing</text>
    <rect x="60" y="340" width="18" height="18" fill="rgb(220,215,205)" rx="3"/>
    <text x="88" y="353" font-family="Georgia, serif" font-size="11" fill="rgb(160,155,148)">prepTime / cookTime — missing</text>
