...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of criminal defense AI SEO: practice area pages by charge type, E-E-A-T attorney credentials, review strategy, and Attorney schema markup">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Criminal defense clients search at the moment of highest urgency. AI answers first.</text>
</svg>
</figure>
