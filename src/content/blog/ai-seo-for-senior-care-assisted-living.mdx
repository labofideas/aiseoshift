...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of senior care AI SEO: care type pages, family education content, E-E-A-T staff credentials, and SeniorCare schema">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">AI answers the 2 a.m. question. The cited provider gets the call.</text>
</svg>
</figure>
