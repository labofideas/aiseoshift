...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 820 400" width="820" height="400" role="img" aria-label="Query transformation diagram showing how search queries evolved from short keyword fragments to long conversational questions in the AI era">
  ...
  <text x="200" y="140" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">3 words · No intent signal · No specificity</text>
  <text x="200" y="158" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">User browses to interpret results</text>
  <text x="200" y="176" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">Keyword match determines ranking</text>
  ...
  <text x="620" y="152" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">12 words · 4 explicit intent signals</text>
  <text x="620" y="170" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">AI delivers the answer directly</text>
  ...
  <text x="104" y="290" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">Category intent</text>
  <text x="104" y="306" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">explicit in query</text>
  ...
  <text x="266" y="290" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">Use-case specificity</text>
  <text x="266" y="306" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">declared upfront</text>
  ...
  <text x="524" y="290" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">Price constraint</text>
  <text x="524" y="306" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">filters answers</text>
  ...
  <text x="701" y="290" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">Comparative evaluation</text>
  <text x="701" y="306" font-family="Georgia, serif" font-size="9" fill="rgb(80,80,80)" text-anchor="middle">signals purchase readiness</text>

  <text x="410" y="375" font-family="Georgia, serif" font-size="10" fill="rgb(80,80,80)" text-anchor="middle">Conversational queries embed 4× more intent signals — content must match all of them to win the citation</text>
  ...
  <text x="410" y="388" font-family="Georgia, serif" font-size="8" fill="rgb(150,150,145)" text-anchor="middle">aiseoshift.com · Query Evolution in the Conversational AI Era</text>
</svg>
</figure>
