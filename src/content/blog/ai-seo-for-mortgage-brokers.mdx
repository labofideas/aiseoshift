...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of mortgage broker AI SEO: loan type pages, rate and cost education, E-E-A-T licensing signals, and MortgageBroker schema">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Mortgage is YMYL. AI engines verify licensing before citing loan guidance.</text>
</svg>
</figure>
