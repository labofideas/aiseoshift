...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of immigration lawyer AI SEO: Immigration type pages, multilingual content strategy, E-E-A-T, and immigration schema">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Iowan Old Style, Georgia, serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">Immigration clients search in their native language before they ever find an attorney.</text>
</svg>
</figure>
