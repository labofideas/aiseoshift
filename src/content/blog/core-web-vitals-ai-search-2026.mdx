...
<svg viewBox="0 0 820 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Core Web Vitals scorecard showing LCP, INP, and CLS thresholds with Good, Needs Improvement, and Poor ranges">
  ...
  <text x="410" y="388" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.65">All three metrics must reach the Good threshold at the 75th percentile of real-user sessions to maintain full AI Overview eligibility.</text>
</svg>
</figure>
