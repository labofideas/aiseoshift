...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 860 500" width="860" height="500" role="img" aria-label="Table showing five AI crawlers — GPTBot, ClaudeBot, PerplexityBot, Google-Extended, Bingbot — with their user-agent strings and what blocking each one costs in AI citation reach">
  ...
  <text x="260" y="200" font-family="Georgia, serif" font-size="10" fill="rgb(80,70,60)" text-anchor="middle">also: anthropic-ai</text>
  ...
  <text x="430" y="468" font-family="Georgia, serif" font-size="10" fill="rgb(120,110,100)" text-anchor="middle">Each crawler feeds a distinct AI platform. Blocking any one removes you from that platform's citation pool — often permanently until the next model retraining cycle.</text>
</svg>
</figure>
