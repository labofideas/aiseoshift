...
<svg viewBox="0 0 800 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Four pillars of insurance agent AI SEO: Google Business Profile with lines of business, coverage education pages, E-E-A-T as licensed advisor, and InsuranceAgency schema">
	...
	<text x="400" y="308" text-anchor="middle" font-family="Figtree, system-ui, sans-serif" font-style="italic" font-size="13" fill="rgb(14,17,22)" fill-opacity="0.7">AI answers insurance questions before aggregators or captive agents get the call.</text>
</svg>
</figure>
